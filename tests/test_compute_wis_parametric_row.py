...
class TestComputeWisParametricRow(unittest.TestCase):
    ...
    def test_wis_returns_finite_for_simple_case(self):
        ...
        self.assertTrue(np.isfinite(wis))
        self.assertGreaterEqual(wis, 0)  # WIS is non-negative
    ...
    def test_wis_includes_0_5_mae_coefficient_bracher_2021(self):
        ...
        self.assertAlmostEqual(wis, mae, delta=0.01)
