...
![commits since v0.15.1](https://img.shields.io/github/commits-since/InstituteforDiseaseModeling/laser-cholera/v0.15.1.svg)
...
- `uv` package and project manager: `python3 -m pip install uv`
  ...
  - `uv venv` optionally specify `--python #` to use a particular version of Python in the virtual environment
  - `uv pip install -e .`
